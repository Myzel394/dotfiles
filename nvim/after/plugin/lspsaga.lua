...
vim.keymap.set("n", "<leader>lg", "<cmd>:Lspsaga goto_definition<CR>", { noremap = true, silent = true, desc = "Go to Definition (LSPSaga)" })

-- Use the below code to open the definition in a new tab
-- vim.keymap.set(
-- 	"n",
-- 	"<leader>lg",
