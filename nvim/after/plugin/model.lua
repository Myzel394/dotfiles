	...
	prompts = {
		["regex_from_example"] = {
			...
			builder = function(input)
				return {
					prompt = "I want you to act as a regex generator. "
			...
			builder = function()
				...
				return {
					messages = {
						{
							role = "system",
							content = "You are an expert at writing commit messages and you are a senior software developer with over 30 years of experience."
